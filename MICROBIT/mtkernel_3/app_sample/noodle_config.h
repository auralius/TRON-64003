...
// Logical buffers start at zero capacity and grow transparently.
  ...
  #else
    /* micro:bit μT-Kernel deployment: reserve the proven 48-KiB arena up
       front.  This avoids repeated Krealloc() growth/relocation during the
       detector pipeline while remaining a grow-only logical arena. */
    #define NOODLE_BUFFER_ARENA_INITIAL_BYTES (48u * 1024u)
  #endif
#endif
